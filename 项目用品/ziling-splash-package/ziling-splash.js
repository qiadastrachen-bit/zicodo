(function () {
  ...
  const template = `
    ...
    <svg class="ziling-splash__logo" viewBox="0 0 1254 1254" aria-label="ZiLing logo">
      <defs>
  ...
  function mount(target, options) {
    ...
    target.setAttribute("aria-label", target.getAttribute("aria-label") || "ZiLing opening splash animation");
